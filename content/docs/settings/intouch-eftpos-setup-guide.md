...
* *(Πατάμε ΟΚ -> Λειτουργία EDPS -> Πατάμε ΟΚ -> 91 -> Πατάμε ΟΚ -> 1234 -> Πατάμε ΟΚ και μας το εκτυπώνει)*
...
| **Τύπος**             | Δίκτυο                                                                    |
| **Ρυθμίσεις Δικτύου** |                                                                           |
 **Διεύθυνση IP**       Την IP που έχει το τερματικό μας την βρίσκουμε με την παρακάτω διαδικασία 
